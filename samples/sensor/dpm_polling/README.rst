...
Make sure the aliases are in the devicetree.

Building on ek_ra6m4 with the Mikroe Power Monitor 2 Click shield
=================================================================

The :ref:`mikroe-power-monitor-2-click` includes two INA219 digital power
monitor sensors.  This shield may also be used on other boards with MikroBUS
headers.
